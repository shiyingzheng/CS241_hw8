...
/*	int i = 1;
	...
	i=1;
	while(i<7){
		bigint_add_digit(myint2, i);
		i++;
	}
	bigint_add_digit(myint2, 3);
	bigint_add_digit(myint2, 4);
	bigint_add_digit(myint2, 6);
	print_bigint(myint);
	printf("\n");
	print_bigint(myint2);
	printf("\n");
	...
	bigint_add_digit(myint2, 6);
//	bigint_add_digit(myint2, 2);
	bigint* sum = add(myint, myint2);
	print_bigint(sum);
